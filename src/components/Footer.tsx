        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <a 
                href="#" 
                className="w-10 h-10 bg-[#6ee7b7] rounded flex items-center justify-center hover:bg-[#5dd6a6] transition"
                aria-label="Facebook"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 flex-1 max-w-3xl">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2">
                <svg className="w-4 h-4 shrink-0 text-white mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-xs text-[#94a3b8] uppercase">CORREO ELECTRÓNICO:</p>
                  <a 
                    href="mailto:contacto@turing-latam.com" 
                    className="text-xs text-white hover:text-[#6ee7b7] transition"
                  >
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-xs text-[#94a3b8] uppercase">TELÉFONO DE CONTACTO:</p>
                  <a 
